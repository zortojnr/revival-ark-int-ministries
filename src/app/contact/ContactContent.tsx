    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24">
          ...
          {/* Contact Form */}
          {/* We wrap the form in Suspense in the parent page, but here we use the hook directly in ContactForm 
              and we need to make sure the component using useSearchParams is wrapped in Suspense.
              
              However, ContactContent itself isn't using useSearchParams, only ContactForm is.
              So if I separate ContactForm component (which uses useSearchParams) and wrap IT in Suspense,
              that would be even safer. But the user asked to wrap the client component in a Suspense boundary.
              
              If I wrap ContactContent in Suspense in page.tsx, that covers everything inside it, including ContactForm.
              So I'll just use ContactForm here.
           */}
           <ContactForm />
        </div>
      </div>
